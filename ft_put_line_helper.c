...
/*   Updated: 2025/12/13 18:12:07 by algasnie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_point_proj point_a, t_point_proj point_b)
{
	...
	bress_a->color = point_a.color;
	bress_b->color = point_b.color;
	bress_a->color_heat = point_a.color_heat;
	bress_b->color_heat = point_b.color_heat;
}
